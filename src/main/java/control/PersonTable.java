...
public class PersonTable extends Application {
    ...
    public void start(Stage stage) {
        ...
        table.getColumns().addAll(PersonTableUtil.getIdColumn(), PersonTableUtil.getFirstNameColumn(),
                PersonTableUtil.getLastNameColumn(), PersonTableUtil.getBirthDateColumn());
    ...
    /**
     * Función que devuelve la fila de cada persona
     *
     * @return GridPane de persona
     */
    ...
    /**
     * Función que elimina filas seleccionadas
     */
    ...
    /**
     * Función que restaura las filas con los valores por defecto
     */
    ...
    /**
     * Función que añade persona a la tabla
     */
